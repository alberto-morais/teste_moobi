            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="<?= base_url('campo/novo') ?>" class="btn btn-sm btn-neutral">Novo</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          <span class="badge badge-dot mr-4">
                                            ...
                                            <span class="status"><?= ($campo->ativo == true) ? 'Ativo' : 'Desativado' ;?></span>
                                          </span>
                                        </td>
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                       href="<?= base_url("campo/editar/{$campo->id}") ?>">Editar</a>
                                                    <?php if (!$campo->ativo):?>
                                                    <a class="dropdown-item"
                                                       href="<?= base_url("campo/active/{$campo->id}") ?>">Atiavar</a>
                                                    <?php else :?>
                                                    <a class="dropdown-item"
                                                       href="<?= base_url("campo/desactive/{$campo->id}") ?>">Desativar</a>
                                                    <?php endif;?>
                                                    <a class="dropdown-item"
                                                       href="<?= base_url("campo/delete/{$campo->id}") ?>">Remover
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
