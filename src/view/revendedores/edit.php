                        ...
                        <div class="col-lg-6 col-7">
                            ...
                            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= base_url('revendedores') ?>">Pedidos</a>
                                    </li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('revendedor/salvar')?>" method="POST">
                                <input type="hidden" name="id" value="<?= $revendedor->id ?>">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="input-nome" class="form-control"
                                                       name="revendedor"
                                                       placeholder="Revendedor Jhon"
                                                       value="<?= old('revendedor') ? old('revendedor') : $revendedor->revendedor  ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-email">Email</label>
                                                <input type="text" name="email" class="form-control money"
                                                       placeholder="revendndor@teste.com" value="<?= old('email') ? old('email') : $revendedor->email  ?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="input-email">Senha</label>
                                                <input type="passoword" name="senha" class="form-control money" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
